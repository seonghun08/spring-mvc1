...
public class RequestBodyJsonController {
    ...
    public String requestBodyJsonV2(@RequestBody String requestBody) throws IOException {
        ...
        HelloData helloData = objectMapper.readValue(requestBody, HelloData.class);
        log.info("helloData={}", helloData);
        log.info("username={}", helloData.getUsername());
        log.info("age={}", helloData.getAge());
    ...
    public String requestBodyJsonV4(HttpEntity<HelloData> data) {
        ...
        log.info("username={}", Objects.requireNonNull(data.getBody()).getUsername());
        log.info("age={}", data.getBody().getAge());
    ...
    public HelloData requestBodyJsonV5(@RequestBody HelloData helloData) {
        helloData.setAge(helloData.getAge() + 1);
        return helloData;
    }
}
